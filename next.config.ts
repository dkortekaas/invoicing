...
const cspDirectives = [
  ...
  "connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://api.stripe.com https://*.vercel-insights.com https://*.vercel-analytics.com",
