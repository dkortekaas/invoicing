...
const PricingCards = () => {
  return (
    <section className="relative" aria-labelledby="pricing-plans-title">
      <h2 id="pricing-plans-title" className="sr-only">
        Prijsplannen
      </h2>
      <div className="container-tight section-padding !pt-8">
        <ul
          className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto list-none"
          role="list"
        >
          {plans.map((plan, index) => {
            ...
            return (
              <li
                key={plan.name}
                className={`relative rounded-2xl p-6 lg:p-8 animate-fade-up ${delayClass} ${
                  plan.popular
        ...
        {/* Price note */}
        <p className="text-center text-sm text-muted-foreground mt-8 animate-fade-in delay-500">
