...
- Business address
- KvK number (8 digits, e.g. `KvK: 12345678`)
...
- A unique, sequential invoice number (e.g. `2026-001`)
- Invoice date
...
1. Create a free Mollie account at mollie.com
1. Verify your KvK number and IBAN
1. Copy your live API key from the Mollie dashboard
1. Paste it in Declair under **Settings → Payments**
...
**[Start free with Declair →](https://declair.app/register)** — no credit card required, free plan includes up to 5 invoices per month.
...
*New to freelancing in the Netherlands? Also read our guide on [Dutch VAT for freelancers](/en/blog/vat-for-freelancers-netherlands) or compare the [best invoicing tools that support Dutch law](/en/blog/best-invoicing-software-freelancers-netherlands).*
