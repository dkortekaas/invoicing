...
canonical: "https://declair.app/en/blog/dutch-vat-for-freelancers-btw-explained"
keywords:
  - Dutch VAT freelancer
  - BTW Netherlands freelancer
  - VAT return Netherlands
  - Dutch tax freelancer
  - ICP declaration Netherlands
  - reverse charge Netherlands
  - KOR Netherlands
  - BTW aangifte expat
howToSteps:
  - name: "Register for VAT with the Belastingdienst"
    text: "When you register your business with the KvK, they automatically notify the Belastingdienst. Within 2 weeks, you receive your BTW identification number by post. This number is required on all invoices."
  - name: "Charge the correct VAT rate on your invoices"
    text: "Most freelance services are charged at 21% VAT. Apply 9% for specific goods and services, and 0% for exports and reverse charge scenarios with EU businesses."
  - name: "Track your output VAT and input VAT"
    text: "Output VAT is the VAT you charge clients. Input VAT is the VAT you pay on business expenses. The difference is what you pay to or reclaim from the Belastingdienst each quarter."
  - name: "File your quarterly VAT return"
    text: "Log in to Mijn Belastingdienst Zakelijk before each quarterly deadline (30 April, 31 July, 31 October, 31 January). Report your output VAT, input VAT, and pay the balance."
  - name: "Submit an ICP declaration if you have EU clients"
    text: "If you invoice VAT-registered businesses in other EU countries using reverse charge, file an ICP (Opgaaf ICP) declaration each quarter listing these transactions."
faq:
  - question: "What is BTW and how does it differ from VAT?"
    answer: "BTW (Belasting over de Toegevoegde Waarde) is simply the Dutch term for VAT (Value Added Tax). They are the same thing. In the Netherlands, you will see BTW used on invoices, tax forms, and in all communication with the Belastingdienst. When speaking to international clients, you can use VAT — they will understand it means the same as BTW."
  - question: "Do all freelancers in the Netherlands need to charge VAT?"
    answer: "Most freelancers must charge VAT. The exception is if you qualify for the KOR (Kleineondernemersregeling) — the Small Business Scheme. If your annual turnover is below €20,000, you can apply to be VAT-exempt. This means you do not charge VAT and do not file quarterly returns, but you also cannot reclaim VAT on your expenses."
  - question: "What is the difference between output VAT and input VAT?"
    answer: "Output VAT is the VAT you charge your clients on your invoices. Input VAT is the VAT you pay on your business expenses (software subscriptions, equipment, office supplies). Every quarter, you report both to the Belastingdienst. If your input VAT is higher than your output VAT, you receive a refund. If your output VAT is higher, you pay the difference."
  - question: "How often do I need to file a VAT return in the Netherlands?"
    answer: "As a freelancer, you file VAT returns quarterly — four times per year. The deadlines are 30 April (Q1), 31 July (Q2), 31 October (Q3), and 31 January (Q4). You file through the Mijn Belastingdienst Zakelijk portal. Missing a deadline results in automatic fines."
  - question: "What is reverse charge and when does it apply?"
    answer: "Reverse charge means your client accounts for the VAT instead of you. It applies when you invoice a VAT-registered business in another EU country. You charge 0% VAT, include your client's VAT number on the invoice, and write 'VAT reverse charged'. You must also file an ICP declaration each quarter listing these transactions."
  - question: "Can I reclaim VAT on expenses I had before registering my business?"
    answer: "Yes, but only for expenses made in the year before your official KvK registration date, and only if you still have the original invoices. This is called startup deduction (startersaftrek). Keep all receipts and invoices — you can reclaim the input VAT on your first quarterly return."
  - question: "What happens if I miss the quarterly VAT filing deadline?"
    answer: "The Belastingdienst issues automatic fines for late VAT returns. The first offense typically results in a fine of €60-€150. Repeated late filings result in higher fines and potential audits. If you know you will miss a deadline, contact the Belastingdienst in advance — they may grant an extension."
  - question: "Do I need a Dutch accountant to file my VAT returns?"
    answer: "No, you can file your own VAT returns through Mijn Belastingdienst Zakelijk. However, many expat freelancers use an accountant for the first year to ensure they understand the system correctly. A good invoicing tool like Declair automatically generates quarterly VAT overviews, making it much easier to file accurately."
---
...
1. **Total output VAT** — VAT you charged clients
1. **Total input VAT** — VAT you paid on expenses
1. **Any special transactions** — reverse charge, exports, private use of business goods
...
1. Charge **0% VAT**
1. Include your **client's VAT number** on the invoice
1. Write: *"VAT reverse charged"* or *"BTW verlegd"*
1. File an **ICP declaration** each quarter
...
*New to freelancing in the Netherlands? Also read our guide on [how to invoice as a freelancer in the Netherlands](/en/blog/how-to-invoice-as-a-freelancer-in-the-netherlands) or learn about [KvK registration for foreign freelancers](/en/blog/kvk-registration-foreign-freelancers-netherlands).*
